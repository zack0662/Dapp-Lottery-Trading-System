...
## 项目运行截图
管理员（同时也是用户一）点击创建赛事：
![GitHub图像](管理员创建赛事.png)
![GitHub图像](创建成功.png)
切换到用户二，可以看到刚才新创建的赛事，点击可以进入赛事页面：
![GitHub图像](用户二进入赛事页面.png)
用户二点击投注赛事，可以进行投注：
![GitHub图像](点击投注.png)
用户二可以点击右上方头像，领取代币，会给每个用户发放500代币：
![GitHub图像](第一次领取代币.png)
投注成功，可以在下方看到自己的彩票：
![GitHub图像](投注成功.png)
用户二进行挂单：
![GitHub图像](进行挂单.png)
切换回用户一，可以看到市场挂单：
![GitHub图像](用户一可看到市场挂单.png)
用户一点击购买之后会进行支付和购买，购买成功之后就成为了自己的彩票：
![GitHub图像](购买成功.png)
